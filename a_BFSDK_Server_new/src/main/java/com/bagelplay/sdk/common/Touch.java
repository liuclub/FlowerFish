...
public class Touch {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MESSAGE_WHAT_TOUCH:
                    ...
                    Window.Callback wc = sdkManager.getWindowCallback();

                    sdkManager.getMouse().debugForTouchShow((int) me.getX(), (int) me.getY());
    ...
    public void doTouch(int pointCount, int action, PointerCoords[] pcs, PointerProperties[] pps) {
        ...
        sdkManager.getMouse().debugForTouchShow((int) pcs[0].x, (int) pcs[0].y);
    }
    ...
    private MotionEvent get1PointTouch(int action, float x, float y) {
        int[] currentWindowLocationXY = sdkManager.getCurrentWindowLocationXY();
